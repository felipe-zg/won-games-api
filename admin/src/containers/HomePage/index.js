      ...
      <Container className="container-fluid">
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block><h2 id="mainHeader">Bem-vindo(a) à Won Games</h2>
              {hasAlreadyCreatedContentTypes ? (
                <P>Ao lado você pode adicionar novos games, categprias, desenvolvedoras e publishers</P>
              ) : (
                <P>Adicione novos games à loja</P>
              )}
              {hasAlreadyCreatedContentTypes && (
